...
* Note: This is a hard fork from https://github.com/kfrancis/chargify-dot-net which removes support for explicit full framework targets and adds support for Coupon Codes.

* Chargify.NET Standard: [![NuGet version](https://img.shields.io/nuget/v/chargify-standard.svg)](http://www.nuget.org/packages/chargify-netstandard)
